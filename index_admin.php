...
<body id="body">
    ...
    <main>
        <div id="contenido-inicio" class="contenido" style="display: block;">
            ...
            <p style="font-size: 16px;text-align: left;margin-left: 10%;"></i>👤 Agregar y editar usuarios</p>
            <p style="font-size: 16px;text-align: left;margin-left: 10%;"></i>👥 Agregar y editar integrantes</p>
            <p style="font-size: 16px;text-align: left;margin-left: 10%;"></i>🌴 Agregar y editar información de vacaciones</p>
            <p style="font-size: 16px;text-align: left;margin-left: 10%;"></i>🔑 Agregar y editar permisos</p>
